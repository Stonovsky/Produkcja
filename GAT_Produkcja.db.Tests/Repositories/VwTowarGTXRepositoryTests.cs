...
namespace GAT_Produkcja.db.Tests.Repositories
{
    ...
    public class TblTowarRepositoryTests
    {
        ...
        [Test]
        [TestCase(90, "PP", false, 1)]
        [TestCase(90, "PES", false, 6)]
        [TestCase(100, "PES", false, 7)]
        public async Task PobierzTowarZParametrow_GdyParametryOk_PobierzTowar(int gramaturaTowaru, string surowiecSkrot, bool czyUv, int idTowar)
        {
