...
{
    [TestFixture]
    public abstract class TestBaseGeneric<TViewModel> 
        where TViewModel : class
    {
        ...
        public Mock<IActivityLogger> ActivityLogger { get; private set; }
        public Mock<IViewModelService> ViewModelService { get; private set; }

        protected TViewModel sut { get; set; }
        ...
        public virtual void SetUp()
        {
            ...
            ActivityLogger = new Mock<IActivityLogger>();
            ...
            ViewModelService.Setup(s => s.ActivityLogger).Returns(ActivityLogger.Object);
        ...
        /// <typeparam name="T">Typ generyczny argumentu fukncji delegata</typeparam>
        /// <param name="TEntity">argument metody/delegata ktora po otrzymaniu wiadomosci bedzie uruchomiona</param>
        protected virtual void MessengerSend<T>(T TEntity, Action methodToInvokeBeforeCallback = null)
            where T : class
        {
            Action<T> callback = null;
