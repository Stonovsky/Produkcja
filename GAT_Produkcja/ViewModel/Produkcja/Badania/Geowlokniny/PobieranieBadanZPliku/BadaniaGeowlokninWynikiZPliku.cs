...
namespace GAT_Produkcja.ViewModel.Produkcja.Badania.Geowlokniny.PobieranieBadanZPliku
{
    ...
    public class BadaniaGeowlokninWynikiZPliku : IBadaniaGeowlokninWynikiZPliku
    {
        #region Properties
        private string sciezkaPliku;
        private readonly IBadaniaGeowlokninRepository repository;
        private readonly bool czyOdswiezycDane;
        ...
        #region CTOR
        public BadaniaGeowlokninWynikiZPliku(IBadaniaGeowlokninRepository repository, bool czyOdswiezycDane = false)
        {
            this.repository = repository;
            this.czyOdswiezycDane = czyOdswiezycDane;
        }

        #endregion

        public tblWynikiBadanGeowloknin PobierzWynikiBadanZPlikuExcel(string sciezkaPliku, tblWynikiBadanGeowloknin badanieZBazy = null)
        {
            ...
            try
            {
                if (badanieZBazy != null)
                {
                    wynikiBadan = badanieZBazy;
                }
                else
                {
